...
gameTitle.prototype = {
	create: function()
	{
		...
		// 240 x 194
		var gameTitle = this.game.add.sprite(this.game.world.centerX,this.game.world.centerY-85,"gametitle");
		...
		*/
		...
		// play: campaign
		var playCampaignButton = this.game.add.button(this.game.world.centerX,this.game.world.centerY+50, 'playcampaignbutton', this.playCampaign, this, 2, 1, 0);
		...
		var playOnlineButton = this.game.add.button(this.game.world.centerX,this.game.world.centerY+107, 'playonlinebutton', this.playOnline, this, 2, 1, 0);
		...
		var achievementsButton = this.game.add.button(this.game.world.centerX,this.game.world.centerY+164, 'achievementsbutton', this.viewAchievements, this, 2, 1, 0);
